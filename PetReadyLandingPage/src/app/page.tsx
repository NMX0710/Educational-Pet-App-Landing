...
export default function Component() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto mt-64 -mb-6 px-4 z-10">
        <div className="grid md:grid-cols-3 gap-4 mb-10">
          ...
          <div className="col-span-2 bg-white px-7 mr-5 -mt-52 z-10">
            {mounted && <BeagleViewer />}
          </div>
        </div>
      </main>

      <footer className="relative w-full z-20" style={{ height: "40vh" }}>
        {mounted && (
